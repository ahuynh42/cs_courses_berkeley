	...
	def chooseAction(self, gameState):
		...
		livingGhostPositionDistributions = \
			[beliefs for i, beliefs in enumerate(self.ghostBeliefs)
			 if livingGhosts[i+1]]
		"*** YOUR CODE HERE ***"
		livingGhostsMLPos = [belief.argMax() for belief in livingGhostPositionDistributions]
		
		closestGhost = (-1, -1)
		closestDist = 9999

		for ghostPos in livingGhostsMLPos:
		...
		for action in legal:
			...
			actionDist = self.distancer.getDistance(successorPosition, closestGhost)
