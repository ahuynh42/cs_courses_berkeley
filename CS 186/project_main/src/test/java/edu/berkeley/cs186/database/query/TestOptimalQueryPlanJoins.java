...
public class TestOptimalQueryPlanJoins {
  ...
  public void testBigJoin() throws DatabaseException, QueryPlanException {
    ...
    QueryPlan queryPlan = transaction.query("tempIntTable1");
    queryPlan.join("tempIntTable2", "tempIntTable1.int", "tempIntTable2.int1");
    queryPlan.executeOptimal();

    QueryOperator finalOperator = queryPlan.getFinalOperator();
    String tree = "type: GRACEHASH\n" +
            "leftColumn: tempIntTable1.int\n" +
            "rightColumn: tempIntTable2.int1\n" +
            "\t(left)\n" +
            "\ttype: SEQSCAN\n" +
            "\ttable: tempIntTable1\n" +
            "\n" +
    ...
    String tree2 = "type: GRACEHASH\n" +
            "leftColumn: tempIntTable2.int1\n" +
            "rightColumn: tempIntTable1.int\n" +
            "\t(left)\n" +
            "\ttype: SEQSCAN\n" +
            "\ttable: tempIntTable2\n" +
            "\n" +
